    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F0ECFF' }} edges={['top']}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <View>
            <Text style={{ fontSize: 13, color: '#9087B8', fontWeight: '500' }}>Welcome back,</Text>
            <Text style={{ fontSize: 26, fontWeight: '800', color: '#1E1448', letterSpacing: -0.5 }}>
          ...
          >
            <Feather name="bell" size={20} color="#7B4FD4" />
        ...
        >
          ...
          >
            ...
            <Text style={{ fontSize: 15, fontWeight: '700', color: '#fff' }}>Record a Match</Text>
          </LinearGradient>
        </Pressable>
        ...
        <View style={{ gap: 12 }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
            {[
              ...
              >
                <Feather name={action.icon} size={20} color="#7B4FD4" />
                <Text style={{ fontSize: 12, fontWeight: '600', color: '#5C4F8A' }}>{action.label}</Text>
              </Pressable>
            ))}
          </View>
        </View>
            ...
            <View style={{ gap: 8 }}>
              {recentNotifications.map((n) => (
                ...
                >
                  ...
                  >
                    <Feather name="bell" size={14} color="#7B4FD4" />
                  </View>
                  <Text numberOfLines={2} style={{ flex: 1, fontSize: 12, color: '#5C4F8A' }}>
                    {n.title}
                  </Text>
                </View>
              ))}
